// --------------------------------------------------------------------------------------------------------------------
// <copyright file="itmConstructorTypeManager.cs" company="imbVeles" >
//
...
namespace imbNLP.PartOfSpeech.nlpTools
{
    ...
    /// Type manager
    /// </summary>
    public class itmConstructorTypeManager : internalPluginManager<IIndustryTermModelConstructor>
    {
        ...
        /// <returns></returns>
        public IIndustryTermModelConstructor GetInstance(String crawler_classname, ILogBuilder loger)
        {
