// --------------------------------------------------------------------------------------------------------------------
// <copyright file="wlfConstructorTypeManager.cs" company="imbVeles" >
//
...
namespace imbNLP.PartOfSpeech.nlpTools
{
    ...
    public class wlfConstructorTypeManager : internalPluginManager<IWLFConstructor>
    {
        ...
        /// <returns></returns>
        public IWLFConstructor GetInstance(String crawler_classname, ILogBuilder loger)
        {
