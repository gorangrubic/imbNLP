// --------------------------------------------------------------------------------------------------------------------
// <copyright file="standardModel.cs" company="imbVeles" >
//
...
namespace imbNLP.PartOfSpeech.pipeline.models
{
    /// <summary>
    ...
    public class standardModel: pipelineModel<pipelineTaskSubjectContentToken>
    {
