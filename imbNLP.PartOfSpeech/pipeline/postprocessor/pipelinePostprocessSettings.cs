// --------------------------------------------------------------------------------------------------------------------
// <copyright file="pipelinePostprocessSettings.cs" company="imbVeles" >
//
...
namespace imbNLP.PartOfSpeech.pipeline.postprocessor
{
    ...
    /// </summary>
    public abstract class pipelinePostprocessSettings
    {
        protected pipelinePostprocessSettings()
        {
        ...
        /// </value>
        public Boolean keepAllInOutput { get; set; } = true;
    }
