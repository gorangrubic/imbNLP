// --------------------------------------------------------------------------------------------------------------------
// <copyright file="pipelineTaskMCPageSubject.cs" company="imbVeles" >
//
...
{
    public class pipelineTaskMCPageSubject: pipelineTaskSubjectContentToken
    {
        public pipelineTaskMCPageSubject()
        {
