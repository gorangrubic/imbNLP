...
namespace imbNLP.PipelineDSLD
{
	...
	public static partial class ExampleElementReferencesTargetsBuilder
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::imbNLP.PipelineDSLD.ExampleElement)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::imbNLP.PipelineDSLD.ExampleElement)
				{
					if (candidateTarget is global::imbNLP.PipelineDSLD.ExampleElement)
					{
						global::imbNLP.PipelineDSLD.ExampleElement sourceExampleElement = (global::imbNLP.PipelineDSLD.ExampleElement)candidateSource;
						global::imbNLP.PipelineDSLD.ExampleElement targetExampleElement = (global::imbNLP.PipelineDSLD.ExampleElement)candidateTarget;
						if(targetExampleElement == null || sourceExampleElement == null || global::imbNLP.PipelineDSLD.ExampleElementReferencesTargets.GetLinks(sourceExampleElement, targetExampleElement).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			{
				if (source is global::imbNLP.PipelineDSLD.ExampleElement)
				{
					if (target is global::imbNLP.PipelineDSLD.ExampleElement)
					{
						global::imbNLP.PipelineDSLD.ExampleElement sourceAccepted = (global::imbNLP.PipelineDSLD.ExampleElement)source;
						global::imbNLP.PipelineDSLD.ExampleElement targetAccepted = (global::imbNLP.PipelineDSLD.ExampleElement)target;
						DslModeling::ElementLink result = new global::imbNLP.PipelineDSLD.ExampleElementReferencesTargets(sourceAccepted, targetAccepted);
