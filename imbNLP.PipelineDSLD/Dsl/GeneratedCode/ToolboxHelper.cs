...
namespace imbNLP.PipelineDSLD
{
	...
	/// </remarks>
	public partial class NLPPipelineDSLDToolboxHelper : NLPPipelineDSLDToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new NLPPipelineDSLDToolboxHelper.
		/// </summary>
		public NLPPipelineDSLDToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class NLPPipelineDSLDToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify NLPPipelineDSLD toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "NLPPipelineDSLD.1.0";
		/// <summary>
		...
		/// <summary>
		/// Constructs a new NLPPipelineDSLDToolboxHelperBase.
		/// </summary>
		protected NLPPipelineDSLDToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::imbNLP.PipelineDSLD.NLPPipelineDSLDDomainModel.SingletonResourceManager.GetString("NLPPipelineDSLDToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			switch(itemId)
			{
				case "imbNLP.PipelineDSLD.ExampleElementToolboxItem":
					// Add ExampleElement shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"imbNLP.PipelineDSLD.ExampleElementToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						"imbNLP.PipelineDSLD.NLPPipelineDSLDToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("NLPPipelineDSLDToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						...
						CreateElementToolPrototype(store, global::imbNLP.PipelineDSLD.ExampleElement.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "imbNLP.PipelineDSLD.ExampleRelationshipToolboxItem":

					// Add ExampleRelationship connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"imbNLP.PipelineDSLD.ExampleRelationshipToolboxItem", // Unique identifier (non-localized) for the toolbox item.
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::imbNLP.PipelineDSLD.NLPPipelineDSLDDomainModel));
