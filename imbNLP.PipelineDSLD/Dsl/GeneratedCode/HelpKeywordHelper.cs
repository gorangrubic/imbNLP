...
namespace imbNLP.PipelineDSLD
{
	...
	/// </remarks>
	public partial class NLPPipelineDSLDHelpKeywordHelper : NLPPipelineDSLDHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new NLPPipelineDSLDHelpKeywordHelper.
		/// </summary>
		protected NLPPipelineDSLDHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the NLPPipelineDSLDHelpKeywordHelper.
		/// </summary>
		public static NLPPipelineDSLDHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class NLPPipelineDSLDHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new NLPPipelineDSLDHelpKeywordHelperBase.
		/// </summary>
		protected NLPPipelineDSLDHelpKeywordHelperBase()
			: base() { }
