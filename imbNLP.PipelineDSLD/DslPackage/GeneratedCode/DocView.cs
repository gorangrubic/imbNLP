...
namespace imbNLP.PipelineDSLD
{
	...
	/// </summary>
	internal partial class NLPPipelineDSLDDocView : NLPPipelineDSLDDocViewBase
	{
		/// <summary>
		/// Constructs a new NLPPipelineDSLDDocView.
		/// </summary>
		public NLPPipelineDSLDDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class NLPPipelineDSLDDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new NLPPipelineDSLDDocView.
		/// </summary>
		protected NLPPipelineDSLDDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			NLPPipelineDSLDDocDataBase docData = this.DocData as NLPPipelineDSLDDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for NLPPipelineDSLDDocViewBase should be an NLPPipelineDSLDDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::imbNLP.PipelineDSLD.NLPPipelineDSLDDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::imbNLP.PipelineDSLD.NLPPipelineDSLDDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::imbNLP.PipelineDSLD.NLPPipelineDSLDToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::imbNLP.PipelineDSLD.NLPPipelineDSLDToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.NLPPipelineDSLDDiagramMenu;
			}
		}
			...
			if(global::imbNLP.PipelineDSLD.NLPPipelineDSLDHelpKeywordHelper.Instance != null)
			{
				...
				if(selectedElement != null)
				{
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::imbNLP.PipelineDSLD.NLPPipelineDSLDHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
