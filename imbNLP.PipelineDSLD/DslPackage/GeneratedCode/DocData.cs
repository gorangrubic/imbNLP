...
namespace imbNLP.PipelineDSLD
{
	...
	/// </summary>
	internal partial class NLPPipelineDSLDDocData : NLPPipelineDSLDDocDataBase
	{
		/// <summary>
		/// Constructs a new NLPPipelineDSLDDocData.
		/// </summary>
		public NLPPipelineDSLDDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a NLPPipelineDSLD document in memory.
	/// </summary>
	internal abstract partial class NLPPipelineDSLDDocDataBase : DslShell::ModelingDocData
	{
		/// <summary>
		...
		/// <summary>
		/// Constructs a new NLPPipelineDSLDDocDataBase.
		/// </summary>
		protected NLPPipelineDSLDDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::imbNLP.PipelineDSLD.NLPPipelineDSLDDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::imbNLP.PipelineDSLD.NLPPipelineDSLDDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::imbNLP.PipelineDSLD.NLPPipelineDSLDDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::imbNLP.PipelineDSLD.NLPPipelineDSLDDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::imbNLP.PipelineDSLD.ExampleModel modelRoot = null;
			...
			global::imbNLP.PipelineDSLD.NLPPipelineDSLDDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::imbNLP.PipelineDSLD.NLPPipelineDSLDSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::imbNLP.PipelineDSLD.NLPPipelineDSLDDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::imbNLP.PipelineDSLD.NLPPipelineDSLDDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::imbNLP.PipelineDSLD.ExampleModel modelRoot = (global::imbNLP.PipelineDSLD.ExampleModel)this.RootElement;
			...
			{
				global::imbNLP.PipelineDSLD.NLPPipelineDSLDDiagram diagram = diagrams[0] as global::imbNLP.PipelineDSLD.NLPPipelineDSLDDiagram;
				if (diagram != null)
				{
					string diagramFileName = fileName + this.DiagramExtension;
					try
					{
						...
						global::imbNLP.PipelineDSLD.NLPPipelineDSLDSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::imbNLP.PipelineDSLD.NLPPipelineDSLDSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::imbNLP.PipelineDSLD.NLPPipelineDSLDDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::imbNLP.PipelineDSLD.NLPPipelineDSLDSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				global::imbNLP.PipelineDSLD.ExampleModel modelRoot = this.RootElement as global::imbNLP.PipelineDSLD.ExampleModel;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::imbNLP.PipelineDSLD.NLPPipelineDSLDSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
