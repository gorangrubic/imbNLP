...
namespace imbNLP.PipelineDSLD
{
	...
	/// </summary>
	internal partial class NLPPipelineDSLDExplorer : NLPPipelineDSLDExplorerBase
	{
		/// <summary>
		/// Constructs a new NLPPipelineDSLDExplorer.
		/// </summary>
		public NLPPipelineDSLDExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the NLPPipelineDSLDExplorerToolWindow.
	/// </summary>
	internal abstract class NLPPipelineDSLDExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new NLPPipelineDSLDExplorerBase.
		/// </summary>
		protected NLPPipelineDSLDExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.NLPPipelineDSLDExplorerMenu;
			}
		}
		...
		{
			get { return global::imbNLP.PipelineDSLD.ExampleModel.DomainClassId; }
		}
