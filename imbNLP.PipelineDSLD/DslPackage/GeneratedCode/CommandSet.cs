...
namespace imbNLP.PipelineDSLD
{
	...
	/// </summary>
	internal partial class NLPPipelineDSLDCommandSet : NLPPipelineDSLDCommandSetBase
	{
		/// <summary>
		/// Constructs a new NLPPipelineDSLDCommandSet.
		/// </summary>
		public NLPPipelineDSLDCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class NLPPipelineDSLDCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new NLPPipelineDSLDCommandSetBase.
		/// </summary>
		protected NLPPipelineDSLDCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewNLPPipelineDSLDExplorerCommand,
				typeof(NLPPipelineDSLDEditorFactory).GUID);
		...
		{
			NLPPipelineDSLDExplorerToolWindow explorer = this.NLPPipelineDSLDExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected NLPPipelineDSLDDocData CurrentNLPPipelineDSLDDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as NLPPipelineDSLDDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected NLPPipelineDSLDDocView CurrentNLPPipelineDSLDDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as NLPPipelineDSLDDocView;
			}
		}
		...
		/// </summary>
		protected NLPPipelineDSLDExplorerToolWindow NLPPipelineDSLDExplorerToolWindow
		{
			get
			{
				NLPPipelineDSLDExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(NLPPipelineDSLDExplorerToolWindow), true) as NLPPipelineDSLDExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				NLPPipelineDSLDExplorerToolWindow explorerWindow = this.NLPPipelineDSLDExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class NLPPipelineDSLDClipboardCommandSet : NLPPipelineDSLDClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new NLPPipelineDSLDClipboardCommandSet.
		/// </summary>
		public NLPPipelineDSLDClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class NLPPipelineDSLDClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new NLPPipelineDSLDClipboardCommandSetBase.
		/// </summary>
		protected NLPPipelineDSLDClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
