// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TestWorkspace.cs" company="imbVeles" >
//
...
namespace imbNLP.Tools
{
    ...
    public class TestWorkspace : aceAdvancedConsoleWorkspace
    {


        /// <summary>
        /// Initializes the workspace for the Test console 
        /// </summary>
        /// <param name="console">The console using this workspace</param>
        public TestWorkspace(TestConsole console) : base(console)
        {
