// --------------------------------------------------------------------------------------------------------------------
// <copyright file="contentElementList.cs" company="imbVeles" >
//
...
namespace imbNLP.Core.contentStructure.collections
{
    ...
    /// </summary>
    public class contentElementList : List<IContentElement>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public bool AddNullSafe(IContentElement element)
        {
           if (element == null)
            {
                return false;
