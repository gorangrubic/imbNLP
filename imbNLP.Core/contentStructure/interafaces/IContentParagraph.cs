// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IContentParagraph.cs" company="imbVeles" >
//
...
namespace imbNLP.Core.contentStructure.interafaces
{
    ...
    public interface IContentParagraph : IContentElement, IQuerableElement<contentParagraphFlag>
    {
        contentSentenceCollection items { get; }
...
// [XmlIgnore]
        ...
        contentParagraphFlag flags { get; set; }
    }
}