// --------------------------------------------------------------------------------------------------------------------
// <copyright file="tokenDetectionFlag.cs" company="imbVeles" >
//
...
namespace imbNLP.Core.contentPreprocess
{
    ...
    public enum tokenDetectionFlag
    {
        ...
        punctationSubSentences,
        quotationSubSentences,
        enumerationSubSentences,
        enbracedSubSentences,
        potentialStreetAndNumber
    }
}