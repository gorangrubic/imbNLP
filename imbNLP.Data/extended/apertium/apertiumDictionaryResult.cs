...
namespace imbNLP.Data.extended.apertium
{
    ...
    public class apertiumDictionaryResult: translationTableMulti<String, String>
    {
        ...
        internal void addLine(String line, Boolean buildModel = true)
        {
            String srb = "";
            String eng = "";
            ...
            if (buildModel)
            {
                ...
                if (!termVsGramFlags.ContainsKey(srb)) termVsGramFlags.Add(srb, posConverter.findPosEnumsFromApertium(apTypes));
...
/*
        ...
        */
        ...
        public List<String> GetForSerbian(String word)
        {
        ...
        public List<String> GetAll()
        {
            ...
            output.AddRangeUnique(GetEnglish());
            output.AddRangeUnique(GetSerbian());
            return output;
        }
