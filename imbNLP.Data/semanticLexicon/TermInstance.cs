// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TermInstance.cs" company="imbVeles" >
//
...
namespace imbNLP.Data.semanticLexicon
{
    public partial class TermInstance : BrightstarEntityObject, ITermInstance 
    {
        ...
        #region Implementation of imbLanguageFramework.semanticLexicon.core.ITermInstance
        ...
        public ITermLemma lemma
        {
            get { return GetRelatedObject<ITermLemma>("lemma"); }
            set { SetRelatedObject<ITermLemma>("lemma", value); }
        }
