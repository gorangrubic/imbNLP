// --------------------------------------------------------------------------------------------------------------------
// <copyright file="lexiconConstructTaskFour.cs" company="imbVeles" >
//
...
namespace imbNLP.Data.semanticLexicon.procedures
{
    ...
    public class lexiconConstructTaskFour : lexiconTaskBase
    {
        public override string taskInputPath
        {
            get
            {
                return "lexicon_concepts_s4_input.txt";
            }
        }
        ...
        public override string taskOutputPath
        {
            get
            {
                return "lexicon_concepts_from_SM-CSP.txt";
            }
        }
        ...
        public override string taskSourcePath
        {
            get
            {
                return "lexicon_concepts_from_synset.txt";
            }
        }
